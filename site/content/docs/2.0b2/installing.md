...
(If you do this, you will notice that running the command first runs the command, which—in this case—quickly notices that it has nothing to do, since everything in the `build` directory is up-to-date.)
